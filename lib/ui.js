...
const BRANDING = {
  // Main Aether logo - clean and modern
  logo: `
${C.cyan}    _    _____ _   _ ______ _____ ______ _______ ${C.reset}
${C.cyan}   / \\  | ____| | | |  _ \\_   _|  ____|__   __|${C.reset}
${C.cyan}  / _ \\ |  _| | |_| | |_) || | | |__     | |   ${C.reset}
${C.cyan} / ___ \\| |___|  _  |  _ < | | |  __|    | |   ${C.reset}
${C.cyan}/_/   \\_\\_____|_| |_|_| \\_\\|_| |_|       |_|   ${C.reset}`,
...
${C.cyan} ╩ ╩╩╚═╩ ╩╚═╝╚═╝╩╚═${C.reset}`,
  ...
  validatorLogo: `
${C.cyan} ╔═╗ ╔═╗╔╦╗╔═╗╔═╗╦═╗${C.reset}  ${C.bright}VALIDATOR NODE${C.reset}
${C.cyan} ║   ╠═╣║║║║ ╦║╣ ╠╦╝${C.reset}
${C.cyan} ╚═╝ ╩ ╩╩ ╩╚═╝╚═╝╩╚═${C.reset}`,
...
${C.cyan}║${C.reset}   ${C.bright}${C.cyan}AETHER${C.reset} ${C.bright}BLOCKCHAIN CLI${C.reset}${' '.repeat(37 - version.length)}${C.dim}v${version}${C.reset}   ${C.cyan}║${C.reset}
${C.cyan}║${C.reset}   ${C.dim}Decentralized Infrastructure for the Future${C.reset}${' '.repeat(15)}${C.cyan}║${C.reset}
${C.cyan}║${C.reset}                                                                   ${C.cyan}║${C.reset}
${C.cyan}╚═══════════════════════════════════════════════════════════════════╝${C.reset}`,
...
`,
  ...
  // Section headers
  section: (title) => `
${C.cyan}── ${C.bright}${title}${C.reset}${C.cyan} ───────────────────────────────────────────────────────${C.reset}`,

  // Subsection
  subsection: (title) => `
  ${C.dim}┌─ ${C.bright}${title}${C.reset}${C.dim} ─────────────────────────────────────────┐${C.reset}`,
};
